...
(defun divine-init-normal-keymap (mode)
  ...
  (define-key mode "0" (defun divine-zero ()
                         (interactive)
                         (if (divine-numeric-argument-p 'noconsume)
                             (divine-then 'digit-argument)
                           (divine-then 'beginning-of-line))))
...
;; Lines
(define-key divine-normal-mode-map (kbd "^") 'beginning-of-line)
...
(define-key divine-normal-mode-map (kbd "g") (defun divine-goto-or-g-mode ()
                                               ...
                                               (if (divine-numeric-argument-p 'noconsume)
                                                 ...
                                                 (divine-then 'divine-transient-g-mode))))
...
(define-key divine-normal-mode-map (kbd "i") (defun divine-insert-mode-or-inside ()
                                               (interactive)
                                               (if (divine-pending-operator-p)
                                                   (if (divine-scope-inside-p 'noconsume)
                                                       (divine-then 'divine-scope-around-force)
                                                     (divine-then 'divine-scope-inside-select))
                                                 (divine-then 'divine-insert-mode))))
